...
@section('content')
    ...
    <div class="py-4 container flex gap-3 items-center">
        ...
        <p class="text-gray-600 font-medium uppercase">Chat</p>
    </div>
            ...
            <div>
                <div class="w-full">
                    <div class="relative flex items-center p-3 border-b border-gray-300">
                        <img class="object-cover w-10 h-10 rounded-full" src="http://i.pravatar.cc/" alt="username" />
                        <span class="block ml-2 font-bold text-gray-600">Admin</span>
                        <span class="absolute w-3 h-3 bg-green-600 rounded-full left-10 top-3">
                        </span>
                    </div>
                    <div class="relative w-full p-6 overflow-y-auto h-[40rem] overflow-y-scroll">
