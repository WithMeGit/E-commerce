        ...
        <form action="{{ route('login') }}" method="post">
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input id="email" type="email" class="input-box" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Email">
                </div>
                @error('email')
                ...
                <div>
                    ...
                    <input id="password" type="password" class="input-box" @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Type Password">
                </div>
                @error('password')
                <div class="bg-yellow-100 rounded-lg py-5 px-6 mb-3 text-base text-yellow-700 inline-flex items-center w-full" role="alert">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="exclamation-triangle" class="w-4 h-4 mr-2 fill-current" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
