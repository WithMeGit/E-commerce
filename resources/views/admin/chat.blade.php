...
@section('content')
    <div class="container mx-auto">
        <div class="min-w-full border rounded lg:grid lg:grid-cols-3">
            <div class="border-r border-gray-300 lg:col-span-1 w-full">
                <div class="mx-3 my-3">
                        ...
                        @foreach ($userList as $key => $user)
                            <a
                                ...
                                <img class="object-cover w-10 h-10 rounded-full"
                                    src="http://i.pravatar.cc/{{ rand(10, 500) }}" alt="username" />
            ...
            <div class="hidden lg:col-span-2 lg:block">
                <div class="w-full">
                    ...
                    <div class="relative w-full p-6 overflow-y-auto h-[20rem] overflow-y-scroll">
                        <ul class="space-y-2">
